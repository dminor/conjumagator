...
class SlightlyIrregularVerb extends Verb {
    ...
    constructor(regular: Verb, present: Map<Pronoun, string>, preterite: Map<Pronoun, string>) {
...
class IrregularVerb extends Verb {
    ...
    constructor(infinitive: string, present: Map<Pronoun, string>, preterite: Map<Pronoun, string>, imperfect: Map<Pronoun, string>) {
        super(infinitive);
        this.present = present;
        this.preterite = preterite;
...
const VERBS: Array<Verb> = [
    ...
    new SlightlyIrregularVerb(new RegularErVerb("creer"), new Map(),
         new Map([["yo", "creí"],
                  ["tú", "creíste"],
                  ["él", "creyó"],
                  ["nosotros", "creímos"],
                  ["ellos", "creyeron"]])),
    new SlightlyIrregularVerb(new RegularArVerb("dar"),
        new Map([["yo", "doy"]]),
        new Map([["yo", "di"],
                 ["tú", "diste"],
                 ["él", "dio"],
                 ["nosotros", "dicimos"],
                 ["ellos", "dieron"]])),
    new SlightlyIrregularVerb(new RegularIrVerb("decir"),
        new Map([["yo", "digo"],
                 ["tú", "dices"],
                 ["él", "dice"],
                 ["nosotros", "decimos"],
        ...
        new Map([["yo", "dije"],
                 ...
                 ["nosotros", "dijimos"],
                 ["ellos", "dijeron"]])),
    new SlightlyIrregularVerb(new RegularArVerb("estar"),
        new Map([["yo", "estoy"],
                 ["tú", "estás"],
                 ["él", "está"],
                 ["nosotros", "estamos"],
        ...
        new Map([["yo", "estuve"],
                 ...
                 ["nosotros", "estuvimos"],
                 ["ellos", "estuvieron"]])),
    new SlightlyIrregularVerb(new RegularErVerb("haber"),
        new Map([["yo", "he"],
                 ["tú", "has"],
                 ["él", "hay"],
                 ["nosotros", "hemos"],
        ...
        new Map([["yo", "hube"],
                 ...
                 ["nosotros", "hubimos"],
                 ["ellos", "hubieron"]])),
    new SlightlyIrregularVerb(new RegularErVerb("hacer"),
        new Map([["yo", "hago"]]),
        new Map([["yo", "hice"],
                 ["tú", "hiciste"],
                 ["él", "hizo"],
    ...
    new IrregularVerb("ir",
        ...
        new Map([["yo", "iba"],
                 ...
                 ["nosotros", "íbamos"],
                 ["ellos", "iban"]])),
    new SlightlyIrregularVerb(new RegularArVerb("llegar"),
                 new Map(), new Map([["yo", "llegué"]])),
    new SlightlyIrregularVerb(new RegularErVerb("poder"),
        new Map([["yo", "puedo"],
                 ["tú", "puedes"],
                 ["él", "puede"],
                 ["nosotros", "podemos"],
        ...
        new Map([["yo", "pude"],
                 ...
                 ["nosotros", "pudimos"],
                 ["ellos", "pudieron"]])),
    new SlightlyIrregularVerb(new RegularErVerb("querer"),
        new Map([["yo", "quiero"],
                 ["tú", "quieres"],
                 ["él", "quiere"],
                 ["nosotros", "queremos"],
        ...
        new Map([["yo", "quise"],
                 ...
                 ["nosotros", "quisimos"],
                 ["ellos", "quisieron"]])),
    new SlightlyIrregularVerb(new RegularErVerb("saber"),
        new Map([["yo", "sé"]]),
        new Map([["yo", "supe"],
                 ["tú", "supiste"],
                 ["él", "supo"],
                 ["nosotros", "supimos"],
                 ["ellos", "supieron"]])),
    new SlightlyIrregularVerb(new RegularIrVerb("salir"),
                 new Map([["yo", "salgo"]]), new Map()),
    new IrregularVerb("ser",
        new Map([["yo", "soy"],
                 ["tú", "eres"],
                 ["él", "es"],
                 ["nosotros", "somos"],
        ...
        new Map([["yo", "era"],
                 ...
                 ["nosotros", "éramos"],
                 ["ellos", "eran"]])),
    new SlightlyIrregularVerb(new RegularErVerb("tener"),
        new Map([["yo", "tengo"],
                 ["tú", "tienes"],
                 ["él", "tiene"],
                 ["nosotros", "tenemos"],
        ...
        new Map([["yo", "tuve"],
                 ...
                 ["nosotros", "tuvimos"],
                 ["ellos", "tuvieron"]])),
    new SlightlyIrregularVerb(new RegularIrVerb("venir"),
        new Map([["yo", "vengo"],
                 ["tú", "vienes"],
                 ["él", "viene"],
                 ["nosotros", "venemos"],
    ...
    new IrregularVerb("ver",
        ...
        new Map([["yo", "veía"],
                 ...
                 ["nosotros", "veíamos"],
                 ["ellos", "veían"]])),
    new SlightlyIrregularVerb(new RegularErVerb("poner"),
                 new Map([["yo", "pongo"]]),
                 new Map([["yo", "puse"],
                          ["tú", "pusiste"],
                          ["él", "puso"],
